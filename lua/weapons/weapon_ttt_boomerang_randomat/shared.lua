if SERVER then
	...
	resource.AddFile("materials/vgui/ttt/icon_boomerang.png")
	
end

if CLIENT then
	SWEP.PrintName			= "Boomerang Fu"
	SWEP.Author			= "Created by TheBroomer and reworked by BocciardoLight"
	SWEP.Slot			= 1
	SWEP.SlotPos			= 2
...
SWEP.Icon = "vgui/ttt/icon_boomerang.png"

SWEP.Base = "weapon_tttbase"
SWEP.Weight			= 5
SWEP.DrawCrosshair		= false

SWEP.Instructions   = "Right click to throw a boomerang"
...
function SWEP:SecondaryAttack()
	...
	-- if SERVER then
		...
		-- boomerang.LastVelocity = self.Owner:GetAimVector()
		-- local phys = boomerang:GetPhysicsObject()
		-- phys:SetVelocity(self.Owner:GetAimVector():GetNormalized()*100)
		-- phys:AddAngleVelocity(Vector(0,-10,0))
	-- end
		-- if SERVER then 
			-- self.Weapon:Remove()
