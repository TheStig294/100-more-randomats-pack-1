...
local minCvar = CreateConVar("randomat_greedy_timer_min", 10, FCVAR_NONE, "Min seconds before a weapon tries to be given", 1, 120)
local maxCvar = CreateConVar("randomat_greedy_timer_max", 60, FCVAR_NONE, "Max seconds before a weapon tries to be given", 1, 120)
local soundCvar = CreateConVar("randomat_greedy_slap_sound", 0, FCVAR_NONE, "Whether a slap sound should play on death", 0, 1)
