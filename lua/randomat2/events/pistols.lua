...
local musicCvar = CreateConVar("randomat_pistols_music", "1", FCVAR_NONE, "Whether music is enabled during showdown", 0, 1)
local yellowTintCvar = CreateConVar("randomat_pistols_yellow_tint", "1", FCVAR_NONE, "Whether a yellow tint screen effect is applied during the duel", 0, 1)
