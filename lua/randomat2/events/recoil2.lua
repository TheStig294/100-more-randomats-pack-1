local EVENT = {}
CreateConVar("randomat_recoil2_max", 15, FCVAR_NONE, "Maximum Magnitude a gun can change someone's velocity by.", 1, 100)
CreateConVar("randomat_recoil2_mul", 6, FCVAR_NONE, "Recoil Multiplier", 1, 100)
