...
CreateConVar("randomat_yeet_cooldown", "10", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "Cooldown between 'yeets', in seconds", 0, 120)

CreateConVar("randomat_yeet_force", "1000", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "'Yeet' force", 1, 10000)
