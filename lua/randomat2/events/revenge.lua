...
local randomat_revenge_multiplier = CreateConVar("randomat_revenge_multiplier", 4.0, FCVAR_NONE, "Multiplier to all prop possession stats", 1, 50)
CreateConVar("randomat_revenge_timer", 0, FCVAR_NONE, "Seconds until this event comes into effect", 0, 600)
local prop_base
local prop_maxbonus
local prop_force
local prop_recharge
