local EVENT = {}
CreateConVar("randomat_freeze2_duration", 5, FCVAR_NONE, "Duration of the Freeze (in seconds)", 1, 60)
CreateConVar("randomat_freeze2_timer", 30, FCVAR_NONE, "How often (in seconds) the Freeze occurs", 5, 60)
