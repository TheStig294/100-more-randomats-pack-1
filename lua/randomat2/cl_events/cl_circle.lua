...
net.Receive("RandomatCircleBegin", function()
    nextZoneX = nil
    nextZoneY = nil
    nextZoneR = nil
    zoneX = nil
    ...
    hook.Add("Think", "RandomatCircleZoneParticles", function()
    ...
    hook.Add("RenderScreenspaceEffects", "RandomatCircleZoneOverlay", function()
        if not zoneR then return end
        local client = LocalPlayer()
...
net.Receive("RandomatCircleZone", function()
...
net.Receive("RandomatCircleShrinkZone", function()
...
net.Receive("RandomatCircleEnd", function()
    hook.Remove("Think", "RandomatCircleZoneParticles")
    hook.Remove("RenderScreenspaceEffects", "RandomatCircleZoneOverlay")
